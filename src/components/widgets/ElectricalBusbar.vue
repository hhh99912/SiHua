...
<template>
  <div class="w-full h-full flex items-center justify-center select-none relative overflow-visible pointer-events-none">
    <!-- Invisible Expanded Hit Area for Easy Dragging -->
    <div class="absolute -inset-y-3.5 inset-x-0 pointer-events-auto cursor-move" />

    <!-- Solid Clean SCADA Busbar Line -->
    <div 
      class="w-full rounded-xs transition-colors pointer-events-auto cursor-move"
      :style="{
