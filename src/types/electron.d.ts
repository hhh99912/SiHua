...
export interface ElectronAPI {
  ...
  models?: {
    loadAll: () => Promise<{ success: boolean; models?: any[]; templates?: any[]; storageDir: string; count: number; files: string[] }>;
    saveOne: (payload: any) => Promise<{ success: boolean; filename?: string; storageDir?: string; error?: string }>;
    deleteOne: (name: string) => Promise<{ success: boolean; filename?: string; error?: string }>;
  };
  cells?: {
    loadAll: () => Promise<{ success: boolean; cells: any[]; storageDir: string; count: number; files: string[] }>;
    saveOne: (cellData: any) => Promise<{ success: boolean; filename?: string; cell?: any; error?: string }>;
    deleteOne: (name: string) => Promise<{ success: boolean; filename?: string; error?: string }>;
  };
}
