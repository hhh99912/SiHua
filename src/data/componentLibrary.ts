...
export const COMPONENT_DEFINITIONS: ComponentDefinition[] = [
  ...
  },
  {
    ...
    category: 'buttons',
    name: '标准控制按钮',
    nameEn: 'Standard Solid Button',
    iconName: 'Power',
    description: '工业实心微晶控制按钮，支持遥控分合闸、指令触发、画面跳转与色彩定制',
    defaultWidth: 140,
    defaultHeight: 46,
    defaultStyle: {
      buttonText: '断路器合闸',
  ...
  },
  {
    ...
    category: 'buttons',
    name: '线框控制按钮',
    nameEn: 'Outline Cyber Button',
    iconName: 'Sparkles',
    description: '半透明微晶深色底座 + 发光细边框，高档 SCADA 主界面控制按钮',
    defaultWidth: 140,
    defaultHeight: 46,
    defaultStyle: {
      buttonText: '画面跳转/监控',
  ...
  },
  {
    ...
    category: 'buttons',
    name: '扁平控制按钮',
    nameEn: 'Flat Control Button',
    iconName: 'Sliders',
    description: '轻量化扁平控制按钮，适合密集控制柜与快速操作面板',
    defaultWidth: 140,
    defaultHeight: 46,
    defaultStyle: {
      buttonText: '复归确认',
